<template>
    <div>
        <div class="h-[100px] bg-secondary px-8 md:px-16 lg:px-20 flex items-center gap-3">
            <h3>
                Home
            </h3>
            ...
            <ChevronRightIcon class="size-4"/>
            <div class="h-9 w-[1.5px] rounded-full bg-[#9F9F9F]"></div>
            <h3>
                Asgard Sofa
            </h3>
        </div>
                ...
                <div class="flex gap-3 text-[#9F9F9F]">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="flex gap-3">
                            <img src="/public/facebook_logo.svg" alt="" class="w-2 h-2">
                            <img src="/public/linkedin_logo.svg" alt="" class="w-2 h-2">
                            <img src="/public/X_logo.svg" alt="" class="w-2 h-2">
                        </div>
                    </div>
                </div>
            </div>
